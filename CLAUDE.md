...
3. الجاي في التطبيق: باقي صفحات اللوحة اللي لسه موقع — بالترتيب المقترح (الدفع والشحن اتعملوا في 2.9، والبوستات في 3.0): جداول النشر `/dashboard/studio/schedules` والحسابات المربوطة `/dashboard/studio/accounts`، إضافة مستقبِل إشعارات من التطبيق، ثم الاستوديو
