...
- **الصفحات اللي فاضلة موقع (بعد 3.5 — ١٩ من ٦٧):** `analytics/{live,reports,signal}`،
  `marketing/{campaigns,channels}`، `inventory/branches`، `products/import`،
...
3. الجاي في التطبيق: باقي صفحات اللوحة اللي لسه موقع — بالترتيب المقترح (الدفع والشحن اتعملوا في 2.9، والبوستات في 3.0، والنشر التلقائي والحسابات في 3.1، والفريق والأجهزة وسجل النشاط في 3.2، والطلب اليدوي في 3.3، وإعدادات الطلبات والشيك أوت وواتساب والبريد في 3.4، والإيصال والسيو وصفحات المتجر والنطاق في 3.5): تقارير التحليلات والزوار دلوقتي، الحملات وقنوات البيع، الفروع واستيراد المنتجات، إضافة مستقبِل إشعارات من التطبيق، ثم الاستوديو
