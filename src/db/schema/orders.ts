...
export const orders = pgTable(
  'orders',
  {
    ...
    /**
     * السوق اللي الطلب جه منه، والعملة اللي العميل شافها ودفع بيها.
     *
     * ## القاعدة الملزمة: **المبالغ فوق تفضل بعملة المتجر الأساسية**
     * `total` و`subtotal` وكل رقم فوق بيفضلوا بالقرش المصري (أو
     * أيًّا كانت عملة المتجر). العميل السعودي بيشوف ريال وبيدفع
     * ريال، والرقم اللي بيتخزّن فوق هو مقابله بعملة المتجر.
     *
     * ## ليه كده لا العكس
     * كل تقرير في المنصة بيجمع `orders.total` — التحليلات
     * والمصروفات وصافي الربح ولوحة اليوم. لو خزّنّا الطلب بعملته،
     * كل تقرير كان هيجمع ريال على جنيه ويطلع رقمًا مالوش معنى،
     * والتاجر يبني قراراته عليه من غير ما يشك.
     *
     * والقيم دي **لقطة**: سعر التحويل بيتخزّن مع الطلب، فالطلب
     * القديم بيفضل بيعرض نفس المبلغ اللي العميل شافه حتى لو التاجر
     * غيّر السعر بعدها بشهر.
     */
    marketId: uuid('market_id'),
    displayCurrency: text('display_currency'),
    displayTotal: money('display_total'),
    /** سعر التحويل وقت الطلب — مضروب في مليون */
