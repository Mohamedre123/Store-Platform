    ...
    <>
      ...
      <Group title="الأزرار">
        <Choice
          ...
          hint={
            b.action === 'add'
              ? 'مناسب للمنتج البسيط. المنتج اللي ليه مقاسات أو ألوان، الإضافة بضغطة معناها إننا بنختار نيابةً عن العميل — وده بيرجّع مرتجعًا مش بيعة.'
              : b.action === 'options'
                ? 'بيودّي لصفحة المنتج يختار المقاس واللون — الأأمن للمنتجات اللي ليها متغيّرات'
                : undefined
          }
        />
