            ...
            <div className="flex flex-col gap-3 rounded-lg bg-[var(--surface-2)] p-4">
              ...
              */}
              ...
              {/*
                ...
                التاجر بيدخل موقع البوابة عشان ياخد التوكن، وبيلاقي
                قدامه زر «اعمل جلسة» فبيعملها ويحطّ رقمه هناك. وبعدين
                بييجي هنا فالبوابة بترفض: «الرقم متسجّل خلاص» — وهو
                مش فاهم إنه هو اللي سجّله.
              */}
              <p className="rounded-lg border border-[var(--color-warning)]/35 bg-[var(--color-warning)]/8 p-2.5 text-xs leading-relaxed">
                <strong>مهم:</strong> على موقع البوابة خُد التوكن <strong>وبس</strong> — ما تعملش
                جلسة وما تحطّش رقمك هناك. إحنا اللي بننشئ الجلسة ونطلّعلك كود المسح من هنا. لو
                عملتها هناك، البوابة هترفض وتقول «الرقم متسجّل خلاص».
              </p>
