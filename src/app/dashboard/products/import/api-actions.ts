...
const schema = z.object({
  /*
    الأنواع هنا لازم تفضل مطابقة لـ`ImportSourceKey`.

    المزوّد اللي بيتضاف في السجل وبيتنسى هنا بيبان في الشاشة
    وبيترفض في الفعل برسالة «بيانات ناقصة» — والتاجر مش فاهم
    إيه الناقص، لأن مفيش حاجة ناقصة.
  */
  source: z.enum(['shopify', 'woocommerce', 'easyorders']),
  /*
