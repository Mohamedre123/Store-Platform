...
export function buildBotSystem(
  ...
  return [
    ...
    '',
    /**
     * نطاق الإجابة مكتوب صراحةً من أول سطر.
     *
     * **من غيره البوت كان بيعتبر سؤال الشحن «بره الموضوع».** قاعدة
     * «اتكلم في المتجر ومنتجاته بس» كانت بتتقرا حرفيًا، فالعميل
     * يسأل «الشحن بكام؟» والبوت يرد بكلام عن المنتجات — والمعلومة
     * مكتوبة قدامه في نفس التعليمات.
     *
     * والشحن والدفع والاسترجاع مش «بره المتجر» — دول أكتر تلات
     * أسئلة بتتسأل قبل الشرا مباشرةً، والرد عليهم هو اللي بيقفل
     * البيعة.
     */
    'إنت بتجاوب عن: المنتجات وأسعارها ومقاساتها وتوفّرها، وأسعار الشحن',
    'ومواعيد التوصيل، وطرق الدفع، وسياسات المتجر. كل دي أسئلة جوّه شغلك.',
    '',
    ...
    */
    ...
    '- **الشحن والدفع والاسترجاع أسئلة أساسية — جاوبها بالأرقام اللي فوق.**',
    '  «الشحن بكام؟» و«بيوصل امتى؟» و«بدفع إزاي؟» دول أهم أسئلة قبل الشرا.',
    '  متردّش عليهم بكلام عن المنتجات، ومتقولش «مش عندي معلومة» وهي مكتوبة قدامك.',
    '- الحاجات اللي فعلًا بره شغلك (أخبار، رياضة، برمجة، رأي في حاجة، أي',
    '  موضوع عام مالوش علاقة بالمتجر) رد عليها: «أنا بساعد في حاجات المتجر بس 🙂»',
