...
export function buildBotSystem(
  ...
  return [
    ...
    '',
    'المنتجات المتاحة وأسعارها ومقاساتها:',
    catalogBlock(brief),
    '',
    /*
      الشحن والدفع والسياسات.

      من غيرهم البوت كان بيقول «مش عندي معلومة دقيقة عن مواعيد الشحن»
      — وده أكتر سؤال بيتسأل قبل الشرا مباشرةً. المعلومة كانت موجودة
      في إعدادات المتجر، وكان ناقص إننا نوريهاله.
    */
    'الشحن والدفع وسياسات المتجر:',
    ...
    '- الأسعار والتوفّر والمقاسات والشحن من المعلومات اللي فوق بالظبط.',
    '  **ما تخترعش سعر ولا منتج ولا مقاس ولا لون ولا مدة شحن مش مذكورة.**',
    '- لو العميل سأل عن الشحن أو الدفع أو الاسترجاع، جاوبه من القايمة اللي',
    '  فوق بالأرقام اللي فيها. **متقولش «مش عندي معلومة» وهي مكتوبة قدامك.**',
    '- لو المعلومة فعلًا مش في اللي فوق، قول إنها مش متسجّلة واعرض إنه يسأل المتجر.',
