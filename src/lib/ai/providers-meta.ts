 ...
 *
 * ## واشتراك ChatGPT — أيًّا كان — مش رصيد API
 * أشهر لخبطة: التاجر مشترك في تطبيق ChatGPT (مجاني أو Go أو Plus أو Pro)
 * فبيفتكر المفتاح هيشتغل بيه. الـAPI حساب منفصل عند OpenAI برصيد مسبق،
 * وده قرار OpenAI مش قرارنا — والجملة بتقول ده صراحةً ومن غير ما تسمّي
 * باقة واحدة، عشان صاحب الباقة التانية ما يفتكرش إن باقته هي الحل.
 */
export const CREDIT_HELP: Record<AiProvider | 'claude', string> = {
  openai:
    ...
    'وأي اشتراك في تطبيق ChatGPT (مجاني أو Go أو Plus أو Pro) منفصل عن الـAPI ومش بيشحن المفتاح.',
  gemini:
