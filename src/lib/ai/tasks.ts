...
export const TASKS: Record<TaskKey, TaskDef> = {
  product_name: {
    label: 'اسم المنتج',
    instruction:
      'اكتب اسم منتج للبيع أونلاين، مبني على **الكلمة اللي العميل بيكتبها في البحث فعلًا**. ' +
      'ابدأ بنوع المنتج، وبعدها أهم صفة تفرّقه (الخامة، الموديل، المقاس، اللون، الاستخدام). ' +
      'ضيف كلمة أو اتنين بيدوّروا بيهم لو مناسبة للمنتج من غير حشو. ' +
      'من غير كلمات دعائية فاضية زي «مميز» و«رائع» و«أفضل»، ومن غير علامات تعجّب ولا إيموجي.',
    maxChars: 70,
    variants: 3,
  },
  product_description: {
    label: 'وصف المنتج',
    /*
      **التحسين هنا بيغني مش بيختصر.**

      الحد كان ٦٠٠ حرف واقتراحين، فالموديل كان بياخد وصفًا كامل
      ويرجّعه في جملتين — والتاجر يلاقي شغله اتقصّ. وصف المنتج طبيعي
      إنه يطول: هو اللي بيرد على أسئلة العميل قبل ما يشتري، وهو
      اللي جوجل بيقرا منه.

      واقتراح واحد لا اتنين: النص الطويل بيرجع كنص واحد متكامل،
      والتفكيك لسطور كان بيقطّعه لعشرين «اقتراح» كل واحد سطر.
    */
    instruction:
      'حسّن وصف المنتج و**وسّعه، ما تقصرهوش أبدًا**. الناتج لازم يكون أطول وأغنى من اللي التاجر كاتبه. ' +
      'ابدأ بفقرة قصيرة عن الفايدة اللي العميل هيحسّها، وبعدين عناوين فرعية قصيرة بالتفاصيل العملية: ' +
      'الخامة أو المكوّنات، المقاسات أو الأبعاد، طريقة الاستخدام، العناية، إيه اللي في العلبة. ' +
      'وفي الآخر سطر أو اتنين بيردّوا على أكتر سؤال بيتسأل قبل الشراء. ' +
      '**وزّع الكلمات اللي العميل بيدوّر بيها طبيعيًا في النص** (اسم المنتج، نوعه، استخدامه) — ' +
      'من غير تكرار مفتعل، جوجل بيعاقب عليه. ' +
      'جُمل قصيرة وسطور منفصلة. من غير مبالغة ولا وعود ما نقدرش نلتزم بيها، ' +
      'ومن غير ما تخترع مواصفات مش موجودة.',
    maxChars: 1800,
    variants: 1,
  },
  short_description: {
  ...
  seo_title: {
    ...
    instruction:
      'اكتب عنوان صفحة لجوجل. لازم يبدأ بالكلمة اللي الناس بتدوّر بيها فعلًا، وفيه اسم المنتج وأهم صفة تفرّقه. ' +
      'حطّ الكلمة المفتاحية في أول ٣٠ حرف — دي اللي بتبان في نتيجة البحث على الموبايل. ' +
      'من غير حشو كلمات مفتاحية مكرّرة — جوجل بيعاقب عليها.',
    maxChars: 60,
    variants: 3,
  },
  seo_description: {
  ...
  category_description: {
    label: 'وصف القسم',
    instruction:
      'اكتب وصفًا لقسم منتجات: إيه اللي فيه، لمين، وليه يتشترى من هنا. ' +
      'حطّ اسم القسم والكلمة اللي بيدوّروا بيها في أول جملة — الوصف ده بيتقرا من جوجل.',
    maxChars: 320,
    variants: 2,
  },
  banner_text: {
